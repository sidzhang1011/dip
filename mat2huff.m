...
%               a uintl6 vector. The other fields of Y contain 
...
%  
%   If X is logical, uint8, uintl6, uint32, int8, intl6, or double, with 
%   integer values, it can be input directly to MAT2HUFF. The minimum
%   value of X must be representable as an intl6.
%
