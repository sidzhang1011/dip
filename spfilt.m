...
%   F = SPFILT(G, TYPE, M, N, PARAMETER) performs spatial filtering of
%   image G using a TYPE filter of size M-by-N. Valid calls to SPFILT are
%   as follows:
%
