...
%                                             decompostion (ld, hd) and
%                                             reconstruction(lr, hr)
%                                             filters for wavelet 'haar'.
%       [ld, hd] = wavefilter('haar', 'd')    Get decomposition filters ld
%                                             and hd.
%       [lr, hr] = wavefilter('haar', 'r')    Get reconstructiobn filters 
%                                             lr and hr.
%
%   INPUTS:
%       WNAME               Wavelet Name
...
switch lower(wname) 
    ...
    case 'db4'
        ld = [-1.059740178499728e-002    3.288301166698295e-002 ...
            ...
            -0.02798376941698385  0.63088076792959044  ...
